...
std::complex<float> asin_2(std::complex<float> z) {
  ...
  float xoy = (((y_gt_safe_max_opt) &&
                (!((y) == (std::numeric_limits<float>::infinity()))))
                   ? ((x) / (y))
                   : (constant_f0));
  bool logical_and_315 = ((y) < (4.3368087e-19)) && ((x) < (one));
  float ap1 = (a) + (one);
...
std::complex<double> asin_3(std::complex<double> z) {
  ...
  double xoy = (((y_gt_safe_max_opt) &&
                 (!((y) == (std::numeric_limits<double>::infinity()))))
                    ? ((x) / (y))
                    : (constant_f0));
  bool logical_and_315 = ((y) < (5.966672584960166e-154)) && ((x) < (one));
  double ap1 = (a) + (one);
