...
def asin_0(z: numpy.complex128) -> numpy.complex128:
    with warnings.catch_warnings(action="ignore"):
        ...
        xoy: numpy.float64 = (
            ((x) / (y)) if ((y_gt_safe_max_opt) and (not (numpy.equal(y, numpy.float64(numpy.inf))))) else (constant_f0)
        )
        logical_and_178: numpy.bool_ = ((y) < (numpy.float64(5.966672584960166e-154))) and ((x) < (one))
        ...
        am1: numpy.float64 = (-(((xp1) * (xm1)) / (ap1))) if (logical_and_178) else (x_ge_1_or_not)
        ...
        imag: numpy.float64 = (
            ...
            else (((y) / (sq)) if (logical_and_178) else (numpy.log1p((am1) + (sq))))
        )
...
def asin_1(z: numpy.complex64) -> numpy.complex64:
    with warnings.catch_warnings(action="ignore"):
        ...
        xoy: numpy.float32 = (
            ((x) / (y)) if ((y_gt_safe_max_opt) and (not (numpy.equal(y, numpy.float32(numpy.inf))))) else (constant_f0)
        )
        logical_and_178: numpy.bool_ = ((y) < (numpy.float32(4.3368087e-19))) and ((x) < (one))
        ...
        am1: numpy.float32 = (-(((xp1) * (xm1)) / (ap1))) if (logical_and_178) else (x_ge_1_or_not)
