...
def atan_0(z: numpy.complex128) -> numpy.complex128:
    with warnings.catch_warnings(action="ignore"):
        ...
        imag_z: numpy.float64 = (z).imag
        x: numpy.float64 = -(imag_z)
        ...
        constant_0: numpy.float64 = numpy.float64(0)
        constant_fxbff0000000000000: numpy.float64 = numpy.float64(-1.0)
        ...
        result = make_complex(
            (
                ...
                if (in_safe_region)
                    ...
                    ((one) if ((y) >= (constant_0)) else (constant_fxbff0000000000000))
                    * (numpy.float64(numpy.float64(numpy.pi)))
                )
            )
            * (numpy.float64(0.5)),
            -(
                (
                    ((one) if ((x) >= (constant_0)) else (constant_fxbff0000000000000))
                    * (
                        numpy.log1p(
                            (numpy.float64(4.0))
                            * (
...
def atan_1(z: numpy.complex64) -> numpy.complex64:
    with warnings.catch_warnings(action="ignore"):
        ...
        y: numpy.float32 = (z).real
        ay: numpy.float32 = numpy.abs(y)
        in_safe_region: numpy.bool_ = ((ax) < (safe_max)) and ((ay) < (safe_max))
        one: numpy.float32 = numpy.float32(1.0)
        naxm1: numpy.float32 = (one) - (ax)
        y2: numpy.float32 = (y) * (y)
        constant_0: numpy.float32 = numpy.float32(0)
        constant_fxbff0000000000000: numpy.float32 = numpy.float32(-1.0)
        ...
        result = make_complex(
            (
                ...
                if (in_safe_region)
                    ...
                    ((one) if ((y) >= (constant_0)) else (constant_fxbff0000000000000))
                    * (numpy.float32(numpy.float32(numpy.pi)))
                )
            )
            * (numpy.float32(0.5)),
            -(
...
def atan_2(z: numpy.float64) -> numpy.float64:
    with warnings.catch_warnings(action="ignore"):
        z = numpy.float64(z)
        result = numpy.arctan(z)
        return result


def atan_3(z: numpy.float32) -> numpy.float32:
    with warnings.catch_warnings(action="ignore"):
        z = numpy.float32(z)
        result = numpy.arctan(z)
        return result
